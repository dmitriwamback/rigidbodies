...
$$ \vec{F}{net,x} = \sum \vec{F}x = \vec{F}{gx} + \vec{F}_{ext}cos(ϕ_1) - \vec{f}_x = ma_x $$

$$ \vec{F}{net,y} = \sum \vec{F}y = \vec{F}{gy} + \vec{F}_{ext}cos(ϕ_2) - \vec{f}_y = ma_y $$

$$ \vec{F}{net,z} = \sum \vec{F}z = \vec{F}{gz} + \vec{F}_{ext}cos(ϕ_3) - \vec{N} = 0 $$

$$ \vec{N} = \vec{F}_{gz} + \vec{F}_{ext,z} $$
