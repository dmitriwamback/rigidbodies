...
$$ \vec{F}x = \sum \vec{F}_x = \vec{F}_{gx} + \vec{F}_{ext}cos(ϕ_1) - \vec{f}_x = ma_x $$

$$ \vec{F}y = \sum \vec{F}_y = \vec{F}_{gy} + \vec{F}_{ext}cos(ϕ_2) - \vec{f}_y = ma_y $$

$$ \vec{F}z = \sum \vec{F}_z = \vec{F}_{gz} + \vec{F}_{ext}cos(ϕ_3) - \vec{N} = 0 $$
